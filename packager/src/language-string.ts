...
/**
 * Extracted from https://github.com/edrlab/thorium-reader/blob/d2c246f0096e9f0ff6451b628b6562282bc666d3/src/common/language-string.ts
 */

import type { IStringMap } from "./profileManifest.type.js";

// import { Contributor } from "@r2-shared-js/models/metadata-contributor";

const BCP47_UNKNOWN_LANG = "unk";
...
export function convertMultiLangStringToString(items: string | IStringMap | undefined, locale: string): string | undefined {
...
export function convertMultiLangStringToLangString(items: string | IStringMap | undefined, locale: string): [lang: string, str: string | undefined] {
    if (typeof items === "object") {
        // see translator.translateContentField() ?
        const langs = Object.keys(items);
        const lang = langs.filter((l) =>
