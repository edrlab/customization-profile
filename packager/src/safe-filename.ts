...
import { trimNormaliseWhitespaceAndCollapse } from "./string.js";
...
export function sanitizeForFilename(str: string) {
    ...
    try {
        ...
        return slugify.default(trimmedAndWhitespaceCollapsed.replace(/\/|\\/g, "_")).replace(/:/g, "-").substring(0, 100) || "FILE";
    }
}
